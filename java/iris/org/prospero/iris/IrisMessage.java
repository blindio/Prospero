...
public class IrisMessage
{
	...
	public IrisMessage( String from, String recipient, InputStream messageStream )
	{
		...
		try
		{
			mimeMessage = new MimeMessage( Session.getDefaultInstance( new Properties() ), messageStream );
		}
	...
	private String getBodyText( BodyPart bodyPart )
	{
		...
		try
		{
			...
			if ( content instanceof String && disposition.toLowerCase().contains( CONTENT_DISPOSITION_INLINE ) )
			{
