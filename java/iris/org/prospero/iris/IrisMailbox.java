...
public class IrisMailbox extends Observable
{
	...
	public IrisMailbox( String mailboxName, String recipientFilterPattern, String senderFilterPattern,
			String subjectFilterPattern, String bodyFilterPattern )
	{
	...
	public boolean addMessage( IrisMessage message )
	{
		...
		{
			matchesFilter = recipientFilter.matcher( message.getRecipient() ).find();
		}
	...
	public void setRecipientFilterPattern( String recipientFilterPattern )
	{
		...
		this.recipientFilter = getRecipientFilterPattern() != null ? Pattern.compile( getRecipientFilterPattern() )
				: null;
	}
	...
	public void setSenderFilterPattern( String senderFilterPattern )
	{
		...
		this.senderFilter = getSenderFilterPattern() != null ? Pattern.compile( getSenderFilterPattern() )
				: null;
	}
	...
	public void setSubjectFilterPattern( String subjectFilterPattern )
	{
		...
		this.subjectFilter = getSubjectFilterPattern() != null ? Pattern.compile( getSubjectFilterPattern() )
				: null;
	}
	...
	public void setBodyFilterPattern( String bodyFilterPattern )
	{
		...
		this.bodyFilter = getBodyFilterPattern() != null ? Pattern.compile( getBodyFilterPattern() ) : null;
	}
