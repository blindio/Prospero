...
import org.prospero.core.utils.BySeleneseLocator;
...
public class WebDriverDriver extends BrowserDriver {
	...
	public boolean isElementVisible(String locator) {
		try {
			WebElement elem;
			elem = getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator));
	...
	public void check(String locator) {
		getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).click();
	}
	
	public String getValue(String locator) {
		return getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).getAttribute(ATTR_VALUE);
	}
	
	public int getOptionCount(String locator) {
		return getWebDriver().findElements(BySeleneseLocator.seleneseLocator(locator)).size();
	}
	...
	public String getAttribute(String attributeLocator) {
		...
		return getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).getAttribute(attribute);
	}
	...
	public String getText(String locator) {
		return getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).getText();
	}
	
	public boolean isChecked(String locator) {
		return getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).isSelected();
	}
	...
	public void select(String locator, String selection) {
		...
		Select select = new Select(getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)));
	...
	public void selectFrame(String locator) {
		...
		if (equalsPos > -1) {
			...
			fail("Invalid locator: " + locator + " locator strategy should read: 'index=int'");
		}
		
		if (strategy.equalsIgnoreCase(SELECT_STRATEGY_INDEX)) {
			setWebDriver(getWebDriver().switchTo().frame(Integer.parseInt(value)));
		}
		else {
			fail("Invalid locator: " + locator + " locator strategy should read: 'index=int'");
		}
	...
	public String executeJavascript(String javascript) {
		...
		try {
			...
			returnVal = jse.executeScript(javascript, (Object[]) null).toString();
		}
	...
	public void typeKeys(String locator, String entry) {
		getWebDriver().findElement(BySeleneseLocator.seleneseLocator(locator)).sendKeys(entry);
	}
