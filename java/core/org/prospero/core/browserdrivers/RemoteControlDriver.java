...
public class RemoteControlDriver extends BrowserDriver {
    ...
    protected static Logger logger = Logger
	    .getLogger(RemoteControlDriver.class);
    ...
    protected RemoteControlDriver(String host, int port, String startCommand,
	    String url) {
	serverHost = host;
	serverPort = port;
	...
	selenium = new DefaultSelenium(serverHost, serverPort,
		browserStartCommand, getSiteUrl());
	selenium.start();
    }
	...
	getSelenium().waitForFrameToLoad(frameAddress,
