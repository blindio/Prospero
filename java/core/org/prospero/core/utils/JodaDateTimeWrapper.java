...
public class JodaDateTimeWrapper {
	...
	private static final DateTimeFormatter formatYMD = DateTimeFormat.forPattern(DATE_FORMAT_STRING_YMD);
	private static final DateTimeFormatter formatMDY = DateTimeFormat.forPattern(DATE_FORMAT_STRING_MDY);
	private static final DateTimeFormatter formatTime = DateTimeFormat.forPattern(TIME_FORMAT_STRING_HHMM);
	...
	public JodaDateTimeWrapper(int year, int month, int dayOfMonth) {
		this.jodaDateTime = new DateTime(year, month, dayOfMonth, 0, 0).withTimeAtStartOfDay();
	}
	
	public JodaDateTimeWrapper(int hour, int minute) {
		this.jodaDateTime = new DateTime().withHourOfDay(hour).withMinuteOfHour(minute);
	}
	...
	public static JodaDateTimeWrapper parseDateTimeStrings(String dateString, String timeString) {
		return JodaDateTimeWrapper.parseDateString(dateString).withTimeString(timeString);
	}
	
	public static JodaDateTimeWrapper parseYMDDateTimeStrings(String ymdDateString, String timeString) {
		return JodaDateTimeWrapper.parseYMDDateString(ymdDateString).withTimeString(timeString);
	}
	
	public static JodaDateTimeWrapper parseMDYDateTimeStrings(String mdyDateString, String timeString) {
		return JodaDateTimeWrapper.parseMDYDateString(mdyDateString).withTimeString(timeString);
	}
	...
	public JodaDateTimeWrapper withTime(int hour, int minute) {
		return new JodaDateTimeWrapper(this.jodaDateTime.withTime(hour, minute, 0, 0));
	}
	
	public JodaDateTimeWrapper withDateString(String dateString) {
		JodaDateTimeWrapper newDate = JodaDateTimeWrapper.parseDateString(dateString);
		return this.withYMD(newDate.getYear(), newDate.getMonthOfYear(), newDate.getDayOfMonth());
	}
	
	public JodaDateTimeWrapper withYMDDateString(String ymdDateString) {
		JodaDateTimeWrapper newDate = JodaDateTimeWrapper.parseYMDDateString(ymdDateString);
		return this.withYMD(newDate.getYear(), newDate.getMonthOfYear(), newDate.getDayOfMonth());
	}
	
	public JodaDateTimeWrapper withMDYDateString(String mdyDateString) {
		JodaDateTimeWrapper newDate = JodaDateTimeWrapper.parseMDYDateString(mdyDateString);
		return this.withYMD(newDate.getYear(), newDate.getMonthOfYear(), newDate.getDayOfMonth());
	}
	...
	public JodaDateTimeWrapper withYMD(int year, int month, int dayOfMonth) {
		return this.withYear(year).withMonthOfYear(month).withDayOfMonth(dayOfMonth);
	}
	...
	public JodaDateTimeWrapper withNextWeekDay() {
		...
		while (nextDay.getDayOfWeek() == SUNDAY || nextDay.getDayOfWeek() == SATURDAY) {
	...
	public JodaDateTimeWrapper withLastDayOfMonth() {
		return new JodaDateTimeWrapper(this.jodaDateTime.dayOfMonth().withMaximumValue());
	}
	
	public JodaDateTimeWrapper withDayOfMonth(int dayOfMonth) {
		return new JodaDateTimeWrapper(this.jodaDateTime.withDayOfMonth(dayOfMonth));
	}
