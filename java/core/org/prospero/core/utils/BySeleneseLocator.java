...
public class BySeleneseLocator extends By {
	 ...
	 * </ul>
	 * </li>
	 * <li><strong>dom</strong>=<em>javascriptExpression</em>: Find an element by evaluating the specified
	 * string. This allows you to traverse the HTML Document Object Model using JavaScript. Note that you must
	 * not return a value in this string; simply make it the last expression in the block.
	 * <ul class="first last simple">
	 ...
	 * </ul>
	 * </li>
	 * <li><strong>css</strong>=<em>cssSelectorSyntax</em>: Select the element using css selectors. Please
	 * refer to <a href="http://www.w3.org/TR/REC-CSS2/selector.html">CSS2 selectors</a>, <a
	 * href="http://www.w3.org/TR/2001/CR-css3-selectors-20011113/">CSS3 selectors</a> for more information.
	 * You can also check the TestCssLocators test in the selenium test suite for an example of usage, which
	 ...
	 * </p>
	 * </li>
	 * <li><strong>ui</strong>=<em>uiSpecifierString</em>: Locate an element by resolving the UI specifier
	 * string to another locator, and evaluating it. See the <a href=
	 ...
	 * similarly-named toggle-buttons.</blockquote>
	 * <p>
	 ...
	 * </p>
	 * <ul>
	 * <li><strong>glob:</strong><em>pattern</em>: Match a string against a "glob" (aka "wildmat") pattern.
	 * "Glob" is a kind of limited regular-expression syntax typically used in command-line shells. In a glob
	 * pattern, "*" represents any sequence of characters, and "?" represents any single character. Glob
	 * patterns match against the entire string.</li>
	 * <li><strong>regexp:</strong><em>regexp</em>: Match a string using a regular-expression. The full power
	 * of JavaScript regular-expressions is available.</li>
	...
	public static By seleneseLocator(String seleneseLocator) throws ProsperoUnsupportedLocatorException {
		...
		if (strategy == null) {
			...
			if (seleneseLocator.substring(0, IMPLICIT_STRATEGY_DOM.length()).toLowerCase().equals(
					IMPLICIT_STRATEGY_DOM)) {
				strategy = STRATEGY_DOM;
			}
			else if (seleneseLocator.substring(0, IMPLICIT_STRATEGY_XPATH.length()).equals(
