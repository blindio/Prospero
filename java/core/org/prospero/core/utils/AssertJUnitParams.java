...
public class AssertJUnitParams {
	...
	public static void assertEmptyString(String actual) {
		assertEmptyString("String [" + actual + "] is not empty or null", actual);
	}
	...
	public static void assertArrayEquals(String message, byte[] expecteds, byte[] actuals) {
		if (assertionFramework == AssertionFramework.JUNIT) {
			...
			org.testng.AssertJUnit.assertArrayEquals(message, expecteds, actuals);
		}
	}
	...
	public static void assertArrayEquals(String message, double[] expecteds, double[] actuals, double delta) {
		if (assertionFramework == AssertionFramework.JUNIT) {
			...
			org.testng.AssertJUnit.assertArrayEquals(message, expecteds, actuals, delta);
		}
	}
	...
	public static void assertStringContainsIgnoreCase(String containerString, String subString) {
		assertTrue(containerString.toLowerCase().contains(subString.toLowerCase()));
	}
	
	public static void assertStringContainsIgnoreCase(String message, String containerString, String subString) {
		assertTrue(message, containerString.toLowerCase().contains(subString.toLowerCase()));
	}
	
	public static void assertStringNotContainsIgnoreCase(String containerString, String subString) {
		assertFalse(containerString.toLowerCase().contains(subString.toLowerCase()));
	}
	
	public static void assertStringNotContainsIgnoreCase(String message, String containerString,
			String subString) {
		assertFalse(message, containerString.toLowerCase().contains(subString.toLowerCase()));
	}
}
