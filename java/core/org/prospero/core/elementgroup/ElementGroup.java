...
public interface ElementGroup {
	 ...
	 * For example if the ElementGroup Id is 'sidious.joblist.0' and the element's id suffix is 'detaillink',
	 * the full id for this element is 'sidious.joblist.0.detaillink'.
	 * 
	 * @return
	 */
	public String getId();
