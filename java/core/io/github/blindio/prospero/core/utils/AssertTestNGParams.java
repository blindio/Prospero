...
public class AssertTestNGParams {
    ...
    public static void assertArrayEquals(double[] actuals, double[] expecteds,
	    double delta) {
	AssertJUnitParams.assertArrayEquals(expecteds, actuals, delta);
    }

    public static void assertArrayEquals(float[] actuals, float[] expecteds,
	    float delta) {
	AssertJUnitParams.assertArrayEquals(expecteds, actuals, delta);
    }
    ...
    public static void assertStringContainsIgnoreCase(String containerString,
	    String subString) {
	AssertJUnitParams.assertStringContainsIgnoreCase(containerString,
		subString);
    }

    public static void assertStringContainsIgnoreCase(String containerString,
	    String subString, String message) {
	AssertJUnitParams.assertStringContainsIgnoreCase(message,
		containerString, subString);
    }

    public static void assertStringNotContainsIgnoreCase(
	    String containerString, String subString) {
	AssertJUnitParams.assertStringNotContainsIgnoreCase(containerString,
		subString);
    }

    public static void assertStringNotContainsIgnoreCase(
	    String containerString, String subString, String message) {
	AssertJUnitParams.assertStringNotContainsIgnoreCase(message,
		containerString, subString);
    }
}
