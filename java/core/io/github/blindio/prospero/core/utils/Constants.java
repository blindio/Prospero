...
public class Constants {
	...
	REMOTECONTROL(DRIVER_REMOTECONTROL), REMOTECONTROL_WITH_JQUERY(
		DRIVER_REMOTECONTROL_WITH_JQUERY), WEBDRIVER(DRIVER_WEBDRIVER), WEBDRIVER_BACKED_SELENIUM(
		DRIVER_WEBDRIVER_BACKED_SELENIUM);
	...
	public static AssertionFramework getAssertionFramework(String framework) {
		...
		logger.warn("Invalid AssertionFramework \"" + framework
			+ "\" Use values (" + TESTNG.toString() + ", "
			+ JUNIT.toString() + ") returning null");
	    }
    ...
    public enum Browser {
	INTERNET_EXPLORER(BROWSER_INTERNET_EXPLORER, true), FIREFOX(
		BROWSER_FIREFOX, true), CHROME(BROWSER_CHROME, true), HTMLUNIT(
		BROWSER_HTMLUNIT, false), ANDROID(BROWSER_ANDROID, false), IPHONE(
		BROWSER_IPHONE, false), IPAD(BROWSER_IPAD, false), GHOSTDRIVER(
		BROWSER_PHANTOMJS, false);
	...
	public static Browser getBrowser(String browserString) {
		...
		browser = FIREFOX;
	    } else if (browserString.equalsIgnoreCase(INTERNET_EXPLORER
		    .toString())) {
		...
		logger.fatal("Invalid browser: " + browserString
			+ " valid values: " + CHROME.toString() + ", "
			+ FIREFOX.toString() + ", "
			+ INTERNET_EXPLORER.toString() + ", "
			+ HTMLUNIT.toString());
	    }
	    return browser;
	}
